...
try:
    ...
    ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["pamlicotrade.org", "www.pamlicotrade.org"])
...
# STATIC
# ------------------------
# STATICFILES_STORAGE = "dan.utils.storages.StaticRootS3Boto3Storage"
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="No-Reply <noreply@pamlicotrade.org>",
)
